...
if len(sys.argv) != 3:
    ...
    file_path1 = '../data/407228326.fasta'
    file_path2 = '../data/407228412.fasta'

    # Print current working directory and absolute paths
    print("Current working directory:", os.getcwd())
    print("Default file 1 path (relative):", file_path1)
    print("Default file 2 path (relative):", file_path2)

    # Convert the file paths to absolute paths and print
    file_path1 = os.path.abspath(file_path1)
    file_path2 = os.path.abspath(file_path2)
    
    print("Default file 1 path (absolute):", file_path1)
    print("Default file 2 path (absolute):", file_path2)
...
# Proceed with the rest of the code if the files are valid
# ...
